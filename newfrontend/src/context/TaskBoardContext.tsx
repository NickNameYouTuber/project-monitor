...
interface TaskBoardContextType {
  ...
  addTask: (taskData: { title: string; description?: string; column_id: string; project_id: string; assignee_ids?: string[]; reviewer_id?: string | null; due_date?: string | null; estimate_hours?: number | null }) => Promise<Task | undefined>;
  updateTask: (taskId: string, updateData: { title?: string; description?: string; column_id?: string; order?: number; assignee_ids?: string[]; reviewer_id?: string | null; due_date?: string | null; estimate_hours?: number | null }) => Promise<Task | undefined>;
...
export function TaskBoardProvider({ children, projectId }: { children: ReactNode; projectId: string }) {
  ...
  const addTask = useCallback(async (taskData: { title: string; description?: string; column_id: string; project_id: string; assignee_ids?: string[]; reviewer_id?: string | null; due_date?: string | null; estimate_hours?: number | null }) => {
    try {
      setLoading(true);
  ...
  const updateTaskFn = useCallback(async (taskId: string, updateData: { title?: string; description?: string; column_id?: string; order?: number; assignee_ids?: string[]; reviewer_id?: string | null; due_date?: string | null; estimate_hours?: number | null }) => {
    try {
      setLoading(true);
