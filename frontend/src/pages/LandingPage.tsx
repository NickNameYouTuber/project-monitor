  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <nav className="flex justify-between items-center px-6 py-4 bg-white/10 backdrop-blur-md">
        <div className="text-[#7AB988] text-2xl font-bold">NIT</div>
        <div className="flex space-x-4">
          <Link to="/login" className="px-6 py-2 bg-[#5DA570] text-white rounded-md hover:bg-[#7AB988] transition-colors">
            Войти
          </Link>
        </div>
      </nav>
      ...
      <main className="container mx-auto px-4 py-12 max-w-6xl">
        ...
        <div className="flex flex-col items-center justify-center mb-16 pt-12">
          <h1 className="text-5xl md:text-7xl font-bold text-center text-[#3A6642] flex flex-wrap justify-center gap-x-4 gap-y-2">
            <span className="relative">
              <span className="text-[#616161] text-3xl md:text-4xl absolute -top-10 left-1/2 -translate-x-1/2 opacity-70 line-through">
                Global
              </span>
          ...
          <p className="mt-6 text-xl md:text-2xl text-[#4C8858] text-center max-w-3xl font-medium">
            Инновационная система управления проектами и кодом с использованием ИИ
          </p>
          <div className="mt-8 flex justify-center">
            <Link to="/login" className="px-8 py-3 bg-gradient-to-r from-[#7AB988] to-[#5DA570] text-white rounded-full font-medium hover:from-[#5DA570] hover:to-[#4C8858] transition-all duration-300 shadow-lg hover:shadow-xl text-lg transform hover:-translate-y-1">
              Начать работу
            </Link>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-20">
          <div className="bg-white/40 backdrop-blur-md p-8 rounded-2xl shadow-xl border border-white/20 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
            <div className="w-14 h-14 bg-gradient-to-br from-[#7AB988] to-[#5DA570] rounded-lg flex items-center justify-center mb-5 rotate-3">
              <svg className="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.2} d="M12 6v6m0 0v6m0-6h6m-6 0H6" />
              </svg>
            </div>
            <h3 className="text-xl font-semibold text-[#3A6642] mb-3">Умное отслеживание</h3>
            <p className="text-[#4C8858]/80 leading-relaxed">
          ...
          <div className="bg-white/40 backdrop-blur-md p-8 rounded-2xl shadow-xl border border-white/20 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
            ...
            <h3 className="text-xl font-semibold text-[#3A6642] mb-3">Командная синергия</h3>
            <p className="text-[#4C8858]/80 leading-relaxed">
          ...
          <div className="bg-white/40 backdrop-blur-md p-8 rounded-2xl shadow-xl border border-white/20 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
            ...
            <h3 className="text-xl font-semibold text-[#3A6642] mb-3">Контроль версий 2.0</h3>
            <p className="text-[#4C8858]/80 leading-relaxed">
        ...
        <div className="flex flex-col items-center mb-24 relative hidden">
          ...
          <div className="relative w-full max-w-5xl px-6">
              ...
              <div className="bg-gradient-to-br from-[#263238] to-[#1a262d] rounded-xl overflow-hidden relative border border-[#37474f] min-h-[400px] flex flex-col">
                <div className="flex border-b border-[#37474f] h-12 px-4 items-center justify-between flex-shrink-0 z-10 relative bg-[#1e2d36]/50">
                  <div className="text-[#b0bec5] font-medium text-sm flex space-x-4">
                    <span className="text-[#7AB988]">Dashboard</span>
                    <span>Projects</span>
                    <span>Repositories</span>
                  </div>
                  <div className="w-8 h-8 rounded-full bg-[#7AB988] flex items-center justify-center text-white text-sm font-bold">N</div>
                </div>
                <div className="flex flex-grow relative z-0 overflow-hidden">
                  <div className="w-48 bg-[#1a262d] border-r border-[#37474f] p-3 flex flex-col flex-shrink-0 z-10 relative">
                    ...
                    <div className="space-y-2 mb-4">
                      <div className="px-2 py-1 bg-[#7AB988]/20 rounded text-[#b0bec5] text-sm flex items-center gap-2 border-l-2 border-[#7AB988]">
                        <div className="w-4 h-4 bg-[#7AB988] rounded-full"></div>
                  ...
                  <div className="flex-grow flex flex-col relative z-0 overflow-hidden bg-[#1e2d36]/30 border-l border-[#2d3f49]">
                    <div className="p-5 flex-grow relative z-0 overflow-hidden">
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                        {[1, 2, 3].map(i => (
                          <div key={i} className="bg-[#263238]/80 border border-[#37474f] rounded-lg p-4 h-32 flex flex-col justify-between overflow-hidden relative z-0 group hover:border-[#7AB988]/50 transition-colors duration-200 cursor-pointer">
                            <div className="flex justify-between items-center mb-2">
                              <span className="text-[#b0bec5] font-medium">Project {i}</span>
                              <span className="text-[#7AB988] text-xs px-2 py-0.5 bg-[#7AB988]/10 rounded-full border border-[#7AB988]/20">Active</span>
                            </div>
                            <p className="text-[#78909c] text-xs mb-3 line-clamp-2">Short description of project {i} goes here with some details.</p>
                            <div className="flex items-center justify-between text-[#78909c] text-xs pt-1 border-t border-[#37474f]/50 group-hover:text-[#7AB988] transition-colors duration-200">
                              <span>Updated 3h ago</span>
                              <span>5 tasks</span>
                            </div>
                            <div className="absolute -right-6 -top-6 w-12 h-12 bg-[#7AB988]/5 rounded-full"></div>
                            <div className="absolute -right-3 -top-3 w-6 h-6 bg-[#7AB988]/10 rounded-full"></div>
                          </div>
                        ))}
                      </div>
                      <div className="bg-[#263238]/80 border border-[#37474f] rounded-lg p-4 flex flex-col overflow-hidden relative z-0 h-56 group hover:border-[#7AB988]/50 transition-colors duration-200 cursor-pointer mb-4">
                        <div className="flex justify-between items-center mb-3">
                          <span className="text-[#b0bec5] font-medium">Repository: frontend</span>
                          <span className="text-[#7AB988] text-xs px-2 py-0.5 bg-[#7AB988]/10 rounded-full border border-[#7AB988]/20">master</span>
                        </div>
                        <div className="flex-grow overflow-hidden text-[#78909c] text-sm font-mono mb-3 line-clamp-5">
                          <span className="text-[#7AB988]">src/components/RepositoryFileExplorer.tsx</span><br />
            ...
            <div className="absolute -bottom-8 left-1/2 transform -translate-x-1/2 bg-white/90 backdrop-blur-lg px-8 py-4 rounded-full shadow-xl border border-white/30 max-w-md w-full mx-4 text-center z-20">
              <span className="text-[#4C8858] font-semibold text-lg">Интерфейс, созданный для продуктивности</span>
            </div>
          </div>
        </div>
        ...
        <div className="text-center mb-16 bg-gradient-to-b from-transparent to-white/10 py-12 px-4 rounded-3xl relative overflow-hidden border border-white/10">
          <h2 className="text-3xl md:text-5xl font-bold text-[#3A6642] mb-6 tracking-tight leading-tight max-w-3xl mx-auto">
            Перейдите на новый уровень управления проектами с NIT
          </h2>
          <p className="text-lg md:text-xl text-[#4C8858]/80 mb-8 max-w-2xl mx-auto">
            Присоединяйтесь к лидерам индустрии, использующим искусственный интеллект для повышения продуктивности.
          </p>
          <Link to="/login" className="inline-block px-10 py-4 bg-gradient-to-r from-[#009688] to-[#4C8858] text-white rounded-full text-lg font-medium hover:from-[#00897b] hover:to-[#4C8858] transition-all duration-300 shadow-xl hover:shadow-2xl transform hover:-translate-y-1">
            Начать прямо сейчас
          </Link>
      ...
      {/* Подвал */}
      <footer className="bg-[#3A6642] text-white py-12 relative overflow-hidden border-t border-[#4C8858]/30">
        <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-r from-[#3A6642]/80 to-[#4C8858]/90"></div>
        <div className="container mx-auto px-4 max-w-6xl relative z-10">
          ...
          <div className="border-t border-[#4C8858]/30 pt-6 text-center text-[#b2dfdb]/60 text-xs">
        ...
        <div className="absolute bottom-0 right-0 w-48 h-48 bg-[#4C8858]/10 rounded-full blur-3xl -mb-24 -mr-24"></div>
        <div className="absolute top-0 left-0 w-48 h-48 bg-[#4C8858]/10 rounded-full blur-3xl -mt-24 -ml-24"></div>
      </footer>
    </div>
  );
};
