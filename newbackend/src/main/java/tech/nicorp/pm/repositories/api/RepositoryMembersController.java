...
public class RepositoryMembersController {
    ...
    public ResponseEntity<List<RepositoryMemberResponse>> list(@PathVariable UUID repositoryId) {
    ...
    public ResponseEntity<RepositoryMemberResponse> add(@PathVariable UUID repositoryId, @RequestBody RepositoryMemberCreateRequest body) {
        Repository repo = repositories.findById(repositoryId).orElse(null);
        if (repo == null) return ResponseEntity.notFound().build();
    ...
    public ResponseEntity<Void> remove(@PathVariable UUID repositoryId, @PathVariable UUID memberId) {
